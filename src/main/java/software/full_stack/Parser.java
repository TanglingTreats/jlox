...
public class Parser {
    ...
    private Stmt.Function function(String kind) {
        ...
        // Assumes left brace has been consumed for more precise error message
    ...
    private Expr finishCall(Expr callee) {
        ...
        if(!check(RIGHT_PAREN)) {
            do {
                // Check arity (number of arguments a function expects)
                if(arguments.size() >= 255) {
                    // Upper limit of arguments become 254 if it is instance method; 'this' is passed implicitly
